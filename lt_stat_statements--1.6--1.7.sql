/* contrib/pg_stat_statements/lt_stat_statements--1.6--1.7.sql */

-- complain if script is sourced in psql, rather than via ALTER EXTENSION
\echo Use "ALTER EXTENSION lt_stat_statements UPDATE TO '1.7'" to load this file. \quit

/* First we have to remove them from the extension */
ALTER EXTENSION lt_stat_statements DROP FUNCTION pg_stat_statements_reset();

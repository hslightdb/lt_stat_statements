...
--
SET lt_stat_statements.track_utility = FALSE;
SET lt_stat_statements.track_planning = TRUE;
...
-- DROP test table
SET lt_stat_statements.track_utility = TRUE;
...
--
-- lt_stat_statements.track = none
--
SET lt_stat_statements.track = 'none';
SELECT pg_stat_statements_reset();
...
--
-- lt_stat_statements.track = top
--
SET lt_stat_statements.track = 'top';
SELECT pg_stat_statements_reset();
...
--
SET lt_stat_statements.track = 'all';
SELECT pg_stat_statements_reset();

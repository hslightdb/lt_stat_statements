...
_PG_init(void)
{
	 ...
	 */
	DefineCustomIntVariable("lt_stat_statements.max",
							"Sets the maximum number of statements tracked by lt_stat_statements.",
							NULL,
							&pgss_max,
							5000,
							100,
	...
	DefineCustomEnumVariable("lt_stat_statements.track",
							 "Selects which statements are tracked by lt_stat_statements.",
							 NULL,
							 &pgss_track,
							 PGSS_TRACK_TOP,
							 track_options,
	...
	DefineCustomBoolVariable("lt_stat_statements.track_utility",
							 "Selects whether utility commands are tracked by lt_stat_statements.",
							 NULL,
							 &pgss_track_utility,
							 true,
							 PGC_SUSET,
	...
	DefineCustomBoolVariable("lt_stat_statements.track_planning",
							 "Selects whether planning duration is tracked by lt_stat_statements.",
							 NULL,
							 &pgss_track_planning,
							 false,
							 PGC_SUSET,
	...
	DefineCustomBoolVariable("lt_stat_statements.save",
							 "Save lt_stat_statements statistics across server shutdowns.",
							 NULL,
							 &pgss_save,
							 true,
							 PGC_SIGHUP,
	...
	EmitWarningsOnPlaceholders("lt_stat_statements");
